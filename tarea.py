    ...
    while True:
        ...
        if results.multi_face_landmarks:
            ...
            if mouth_opening > max_mouth:
                ...
                if drowsy_frames > 20:
                    cv.putText(img=frame, text='Alerta de fatiga', org=(200, 300), fontFace=cv.FONT_HERSHEY_SIMPLEX, fontScale=1, color=(0, 255, 0), thickness=2)
                ...
                if yawning_frames > 20:
                    cv.putText(img=frame, text='Alerta Bostezo', org=(200, 300), fontFace=cv.FONT_HERSHEY_SIMPLEX, fontScale=1, color=(0, 0, 255), thickness=2)
        else:
            # Si no se detecta ningún rostro, mostrar el fotograma sin la malla facial
            cv.imshow('img', frame)
